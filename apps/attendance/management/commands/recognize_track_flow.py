...
class Command(BaseCommand):
    help = "Track-first recognition flow testi"

    def add_arguments(self, parser):
        parser.add_argument("--track-key", type=str, required=True)
    ...
    def handle(self, *args, **options):
        ...
        result = service.recognize_track_and_record(
            track_key=options["track_key"],
        ...
        self.stdout.write(self.style.SUCCESS("Track recognition flow tugadi"))
